...
<!-- Mirrored from www.Crystalsexchange.com/?a=forgot_password by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 15 Jan 2021 03:52:18 GMT -->
...
<div class="row">
<div class="col-lg-12">
<div class="main-title main-title_lower" data-aos="fade-right" data-aos-delay="0">Forgot Password</div>
<div class="main-subtitle" data-aos="fade-right" data-aos-delay="0">Password Recovery</div>
...
<form method=post name=forgotform onsubmit="return checkform();" class="sign"><input type="hidden" name="form_id" value="16106827123793"><input type="hidden" name="form_token" value="679f1d3384594cbf76b3b58747c04065">
<input type=hidden name=a value="forgot_password">
<input type=hidden name=action value="forgot_password">
<label class="sign-input">
<input type="text" value="" name='email' value="" autofocus required>
<div class="sign-input-wrap">
<div class="sign-input__check">
<svg>
<use xlink:href="assets/img/sprite.html#check"></use>
</svg>
</div><span><svg><use xlink:href="assets/img/sprite.html#mail"></use></svg>Username or E-mail</span></div>
</label>
<div class="sign-capch">
<div class="sign-bot login-mod">
<button class="main-btn" type="submit" name="auth_form_btn">Check</button>
</div>
</div>
</form>
</div>
