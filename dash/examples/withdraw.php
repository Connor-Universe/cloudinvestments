                  ...
                  <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" <?php echo"$dis";?> class="form-control" id="amount" name="amount"aria-describedby="Amount" min="5" max="<?php echo"$amount";?>" placeholder="Enter Withdraw Amount">
                            <small id="amount"  class="form-text text-muted">We'll never share your bitcoin address and other personal details with anyone else!.</small>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">bitcoin Address</label>
                            <input type="text" class="form-control" id="btc" placeholder="Enter receiving bitcoin address" name ="wallet" <?php echo"$dis";?>>
                        </div>
                        <div class="form-check">
                            <label class="form-check-label">
                                <input class="form-check-input" type="checkbox" value="">
                                Remember this bitcoin address?
           ...
           <div class="row">
               ...
               <div class="card card-nav-tabs text-center">
                            <div class="card-header card-header-primary">
                               <h3>  Crystalsexchange Plc Withdraw</h3>
                            </div>
                            <div class="card-body">
