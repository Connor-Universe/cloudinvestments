...
<div class="wrapper">
  ...
  <div class="card-body">
    ...
    <?php echo"$fail";?>
      <div class="form-row">
         <input type="file" name="verify" class="form-control" placeholder="Screenshot of payment" require>
         <input type="number" name="amount" class="form-control" placeholder="Enter bitcoin amount" require>
      </div>
           ...
           <div class="row">
               ...
               <div class="card card-nav-tabs text-center">
                            <div class="card-header card-header-primary">
                               <h3>  Crystalsexchange Plc verification</h3>
                            </div>
                            <div class="card-body">
