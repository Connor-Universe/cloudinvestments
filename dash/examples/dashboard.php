            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <h4 class="card-header card-header-info">Crystalsexchange Id's</h4>
                        <div class="card-body">
                            <h4 class="card-title">Username : <?php echo"$username";?></h4>
                            <h4 class="card-title">ID NO : <?php echo"$id_no";?></h4>
                            <h4 class="card-title">Referal Link: https://crystalsexchange.com/indexcca3.php?r=<?php echo"$referal_code";?></h4>
                ...
                <div class="row">
                    ...
                    <div class="card card-nav-tabs text-center">
                      ...
                      <div class="card-body">
                          ...
                          <h4 class="card-text text-muted">Total Invested</h4>
                          <a href="invest.php" class="btn btn-primary">Invest</a>
                      </div>
                    ...
                    <div class="card card-nav-tabs text-center">
                      ...
                      <div class="card-body">
                          <h4 class="card-title"><?php echo"$total_withdraw[value_sum]";?></h4>
                    ...
                    <div class="card card-nav-tabs text-center">
                      ...
                      <div class="card-body">
                          <h4 class="card-title"><?php echo"$final";?></h4>
                    ...
                    <div class="card card-nav-tabs text-center">
                      ...
                      <div class="card-body">
                          <h4 class="card-title"><?php echo"$amount";?></h4>
