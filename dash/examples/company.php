...
<div class="wrapper">
    ...
    <div class="main-panel">
      ...
      <div class="content">
        <div class="row">
          <div class="col-12">
              <h3>Crystalsexchange 2020 Performance Charts</h3>
            <div class="card card-chart">
              <div class="card-header ">
                <div class="row" id="performance">
                  <div class="col-sm-6 text-left">
                    <h5 class="card-category">Crystalsexchange Plc</h5>
                    <h2 class="card-title">New York Stock Exchange Market Performance</h2>
                  </div>
                  <div class="col-sm-6">
                    <div class="btn-group btn-group-toggle float-right" data-toggle="buttons">
                      ...
                      <label class="btn btn-sm btn-primary btn-simple" id="2">
                        ...
                        <span class="d-none d-sm-block d-md-block d-lg-block d-xl-block">Profit</span>
                        <span class="d-block d-sm-none">
        ...
        <div class="row">
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Total New Investors</h5>
                <h3 class="card-title"><i class="tim-icons icon-bell-55 text-primary"></i> 63,215</h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Daily Investments</h5>
                <h3 class="card-title"><i class="tim-icons icon-delivery-fast text-info"></i> $153,500</h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
          ...
          <div class="col-lg-4">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Daily Withdrawls</h5>
                <h3 class="card-title"><i class="tim-icons icon-send text-success"></i> $112,100</h3>
              </div>
              <div class="card-body">
                <div class="chart-area">
           ...
           <div class="row">
               ...
               <div class="card card-nav-tabs text-center">
                            <div class="card-header card-header-primary">
                               <h3>  Crystalsexchange Plc 2020 Performance</h3>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title text-primary">Disclaimer</h4>
                                <p class="card-text">To show transparency we at Crystalsexchange Plc actively display our company Performance for our investors to see so that our investors know they can trust us with their funds</p>
                                ...
                                <a href="company.php#performance" class="btn btn-primary">Go Up</a>
                            </div>
