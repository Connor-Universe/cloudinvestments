                  ...
                  <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                <label for="inputState">Perfect Money Address</label>
                 ...
                 <div class="card">
                       <div class="card-body">
                           ...
                           <div class="form-row">
                               ...
                               <label for="inputState">Perfect Money Address</label>
                               <input type="text" class="form-control" id="inputAddress" placeholder="Enter New Perfect Money address" name="country">
                               </div>
           ...
           <div class="row">
               ...
               <div class="card card-nav-tabs text-center">
                            <div class="card-header card-header-primary">
                               <h3>  Crystalsexchange Plc Profile</h3>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title text-primary">Disclaimer</h4>
                                <p class="card-text">You can edit your profile at anytime you want, just be sure to remember all the information you change so you won't forget them in your next login</p>
                                ...
                                <p class="card-text">YOU CAN NOT CHANGE YOUR Crystalsexchange ID NO</p>
