    ...
    <div class="content">
       <div class="invest">
               ...
               <div class="row">
                   <div class="col-lg-12" id="invest">
                       ...
                       <div class='card card-nav-tabs text-center'>
                            ...
                            <div class='card-body'>
                                <h4 class='card-title'>$percentage% after $day day(s)</h4>
                              
                                <a href='payment.php?id=$id' class='btn btn-primary'>Invest</a>
                            </div>
           ...
           <div class="row">
               ...
               <div class="card card-nav-tabs text-center">
                            <div class="card-header card-header-primary">
                               <h3>  Crystalsexchange Plc Investment Plans</h3>
                            </div>
                            <div class="card-body">
                                <h4 class="card-title text-primary">Disclaimer</h4>
                                <p class="card-text">Investment in our plans gives you weekly returns on your investment until the expiry date (2 months), the more you invest the more you earn. So invest with us today!</p>
                                <p class="card-text">TO LIMIT RISK, COMPANY POLICY STATES YOU CAN ONLY INVEST IN ONE PLAN AT A TIME</p>
