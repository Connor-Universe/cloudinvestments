...
session_start();
 ...
 $get_user = "select * from withdraw_request";
...
<div class="wrapper">
    ...
    <tbody>
        ...
        while($row_user = mysqli_fetch_array($run_user)){
          ...
          $amount_dollar = $row_user['amount'];
          $btc = $row_user['btc'];
          $reference = $row_user['reference_no'];
          $id = $row_user['id'];
          ...
          $get_user = "select email from users where id_no = $id_no";
          $run_user = mysqli_query($connect,$get_user);
          ...
          <tr>
           ...
           <td>$reference</td>
           <td>$verifieds</td>
           <td><a href='verify_withdraw.php?id=$id&&amount=$amount_dollar&&no=$id_no&&email=$email_user' rel='tooltip' class='btn btn-primary btn-sm btn-icon'>
           <i class='tim-icons icon-simple-add'></i>
       </a> 
       <a href='delete_withdraw_request.php?id=$id&&amount=$amount_dollar&&no=$id_no' rel='tooltip' class='btn btn-danger btn-sm btn-icon'>
