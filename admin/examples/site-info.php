                  ...
                  <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-row">
                                ...
                                <input type="text" class="form-control" id="inputEmail4" placeholder="<?php echo"$location";?>" disabled>
                                </div>
                                <div class="form-group col-md-6">
                                <label for="inputPassword4">Phone</label>
                                <input type="text" class="form-control" id="inputPassword4" placeholder="<?php echo"$phone";?>" disabled>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputPassword4" placeholder="<?php echo"$password";?>" disabled>
                                </div>
                                <div class="form-group col-md-12">
                                <label for="inputPassword4">Wallet Address</label>
                                <input type="text" class="form-control" id="inputPassword4" placeholder="<?php echo"$wallet";?>" disabled>
                                </div>
                            </div>
                            
                            
                            <a href="site-info.php#change" class="btn btn-primary">Change settings</a>
                            </form>
                        </div>
                        </div>
                 ...
                 <div class="card">
                       <div class="card-body">
                           ...
                           <div class="form-row">
                               ...
                               <label for="inputEmail4">Location</label>
                               <input type="text" class="form-control" name ="location" id="inputEmail4" placeholder="Location">
                               </div>
                               <div class="form-group col-md-6">
                           ...
                           <div class="form-row">
                               ...
                               <div class="form-group col-md-4">
                               <label for="inputPassword4">Wallet Address</label>
                               <input type="text" class="form-control" id="inputPassword4" placeholder="Wallet" name="wallet">
                               </div>
                               
                           </div>
                           
                           <button type="submit" class="btn btn-primary" id="change">Edit Settings</button>
                           </form>
                       </div>
                       </div>
                            </div>
