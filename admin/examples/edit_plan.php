...
session_start();
 ...
 $id_plan = $_GET['id'];
 $get_user = "select * from plans where id = $id_plan";
        ...
        <div class="dash">
            <div class="container">
              ...
              <div class='card card-nav-tabs text-center'>
                ...
                <div class="row">
                 <h3>Enter your edits</h3>
                 <div class="col-lg-12">
                 <form action="edit_plans.php" method="POST" id="edit">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <label for="inputEmail4">Edit Plan Name</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <label for="inputEmail4">Edit Lower Amount</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <label for="inputEmail4">Edit Upper Amount</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <label for="inputEmail4">Edit Percentage</label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                <label for="inputEmail4">Edit Days</label>
