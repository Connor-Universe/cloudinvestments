...
$mail->Subject = "bonus Notification: $first_name $last_name";
...
<p align=left> 
Hello $first_name $last_name,</p> <p> A bonus has successfully been sent to your wallet! Here is your bonus information</p>
<p> Amount:$amount </p>
<p> Wallet : $wallet</p>
<p> Reference Id : $reference_id</p>
<p> Regards From </p>
<p> Crystal Exchange Plc</p>";
...
if (!$mail->send()) {
    ...
    $insert_bonus = "INSERT INTO bonus (id_no,amount,reference_id) VALUES('$id_no','$amount','$reference_id')";
...
$run_insert_total = mysqli_query($connect,$insert_total);
    header("location:add_bonus.php#$id_no");
}
