...
if(isset($_POST['add'])){
    ...
    $insert_invest = "INSERT INTO add_funds (amount,id_no) VALUES('$amount','$id_no')";
    $run_invest = mysqli_query($connect,$insert_invest);
...
$run_insert_total = mysqli_query($connect,$insert_total);
    header("location:dashboard.php#$id_no");
}elseif(isset($_POST['remove'])){
    $amount = $_POST['amount'];
    $id_no = $_POST['id'];

    $insert_invest = "INSERT INTO remove_funds (amount,id_no) VALUES('$amount','$id_no')";
    $run_invest = mysqli_query($connect,$insert_invest);
    $investments = "select * from investments where id_no = $id_no";
$run_investments = mysqli_query($connect,$investments);
$row_invest = mysqli_fetch_array($run_investments);
