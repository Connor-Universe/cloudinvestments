...
$mail->Subject = 'Referal Email: Crystals Exchange Plc';
...
<strong>Fail</strong> Registeration failed, please try again later
  ...
  <strong>Success</strong> Thank you $first_name for registering! You will be redirected to your login page shortly
   ...
   $insert_user = "INSERT INTO users (first_name, last_name , email , wallet , username , country , referal_code , password_user , ip , token , id_no , promo_code , verified) 
   VALUES ('$first_name','$last_name','$email','$btc_address', '$username' , '$country', '$referal_code', '$password', '$ip', '$token', '$id_no', '$promo', '$verified' )";
